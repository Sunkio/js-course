...
function js4 () {
    ...
    // The toString() method returns a string representing the specified Number object. The toString() method is used to convert a number to a string.
    console.log(myNumber.toString()); // '42'
    console.log("JS-4: END");
}
